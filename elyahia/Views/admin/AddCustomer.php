        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <?php require_once "navbar.php";?>
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">ِِAdd customer</h3>
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-header text-end py-3">
                                            <p class="text-end text-primary m-0 fw-bold">اضافة عميل جديد</p>
                                            ...
                                            <form action="includes/addCustomer.php" method="post">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <input class="form-control" type="text" id="balance" name="balance" required=""></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label text-end float-end" for="cname"><strong>الاسم</strong><br></label>
                                                        <input class="form-control" type="text" id="cname"  name="cname" required=""></div>
                                                    </div>
                                                </div>
                                                <div class="mb-3"><button class="btn btn-primary btn-sm float-start" type="submit">إضافة عميل</button></div>
                                            </form>
                                        </div>
                                    </div>
